...
def test_embedder():
    from embedders import TransformerEmbeddings, InfinityEmbeddings
...
def test_digestor():
    from agents import VLLMMicroAgent
    ...
    save_json("digestor-structured-output-results", [r.model_dump() for r in result])

def test_extractor():
    from agents import EntityExtractor
...
#     from tqdm import tqdm
#     from embedders import create_digestor
#     from models import Digest
